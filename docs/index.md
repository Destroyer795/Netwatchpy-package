...
* **Database Pruning & Downsampling:** Automated retention policy compressing older data into hourly summaries and purging stale granular records to prevent database bloat.
